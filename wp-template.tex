...
{{#rdflet this idd:number = idd-number }}
  ...
  & {{idd-number}} & & & & & Лабораторные работы \\\hline
  {{/with}}
  {{/rdfeach}}
{{/rdflet}}
...
\noindent{\footnotesize%
  \begin{longtblr}[
    ...
    label=none
      ...
      colspec={|X[4,l]|X[1,l]|X[1,c]|X[1,c]|X[2,l]|X[1.5,l]|},
      rowhead=2
    }
  \hline
  ...
  & Вид самост. работы & Сроки выполнения, нед. & Затраты времени &  & \\\hline
  {{#rdfeach syll wpdd:itemList ?wpdd:TopicList ?wpdd:ItemList}}
  {{#with this ^schema:member ?wpdd:ListItem ?wpdd:Topic}}
  Тема~{{this dcterms:identifier}}.~{{this rdfs:label}}
  & Подготовка к защите лаб. работ &  &  & Содержание в отчете по лаб. работе  & г-[\ref{}], а-[\ref{}] \\\hline
  {{/with}}
  {{/rdfeach}}
...
\noindent{\footnotesize%
%  \begin{tblr}{|p{5cm}|m{1cm}|m{1cm}|m{1cm}|m{1cm}|m{1cm}|p{2cm}|}
  \begin{tblr}{|X[4,l]|X[1,c]|X[2,l]|X[1,l]|}
  \hline
\SetCell{c}Тема занятия &
  \SetCell{c}Всего часов & \SetCell{c}Оценочные средства & \SetCell{c}Формируемые компетенции \\\hline
  {{#rdfeach syll wpdd:itemList ?wpdd:PracticeTopicList ?wpdd:ItemList}}
  {{#with this ^schema:member ?wpdd:ListItem ?wpdd:PracticeTopic}}
  Тема~{{this dcterms:identifier}}.~\emph{ {{this rdfs:label}} }\par
  &  & Отчет по лабораторной работе & ПК-.. \\\hline
  {{/with}}
  {{/rdfeach}}
\end{tblr}}
...
\noindent{\footnotesize%
%  \begin{tblr}{|p{5cm}|m{1cm}|m{1cm}|m{1cm}|m{1cm}|m{1cm}|p{2cm}|}
  \begin{tblr}{|X[3,l]|X[3,l]|X[1,l]|}
  \hline
  \SetCell{c}Тема &
  \SetCell{c}Задание & \SetCell{c} Формируемые компетенции \\\hline
...
\begin{rdfctx}{\rdfsetctx{list}{syll wpdd:itemList !wpdd:BaseReferenceList !wpdd:ItemList}}
  \begin{enumerate}
      \item \rdf{list ^schema:member !wpdd:ListItem !wpdd:Reference}{...\;:\;[текст]\;....} % \label{}
  \end{enumerate}
\end{rdfctx}
...
\begin{rdfctx}{\rdfsetctx{list}{syll wpdd:itemList !wpdd:EReferenceList !wpdd:ItemList}} % \label{}
\begin{enumerate}
...
\begin{rdfctx}{\rdfsetctx{list}{syll wpdd:itemList !wpdd:InternetResources !wpdd:ItemList}}
  \begin{enumerate}
  \item \rdf{list ^schema:member !wpdd:ListItem !wpdd:InternetResource}{....\;:\;[сайт] -- URL: \url{...}} % \label{}
  \end{enumerate}
\end{rdfctx}
...
%    \item \rdf{list ^schema:member !wpdd:ListItem !wpdd:Software}{Windows 7 или новее, }
%    \item \rdf{list ^schema:member !wpdd:ListItem !wpdd:Software}{Редактор Microsoft Office 2007 или новее, }
...
\noindent{\footnotesize%
  ...
  \hline
  \SetCell{c} Вид контроля &
  \SetCell{c} Контролируемые темы & \SetCell{c} Контролируемые компетенции \\\hline
  {{#rdfeach syll wpdd:itemList ?wpdd:IndependentWorkTopicList ?wpdd:ItemList}}% _ hrs
  {{#with this ^schema:member ?wpdd:ListItem ?wpdd:IndependentWorkTopic}}
  & Тема~{{this dcterms:identifier}}.~{{this rdfs:label}} &
{{#rdfeach disc idd:hasCompetence}}
{{this dcterms:identifier}};
...
\paragraph{Список вопросов для промежуточной аттестации (примеры):}
...
% Примеры заданий находятся в разделе курса на сайте \url{https://edu.irnok.net}, а также в ЭИОС ИГУ, URL:~\url{https://educa.isu.ru}.
...
\rdf{syll wpdd:courseDC schema:author {foaf:name rdf:label} !foaf:Person !wpdd:Author}{....} % Иванов И.В., канд.техн.наук, доцент. %;
%ассистент: \rdf{syll wpdd:courseDC schema:author {foaf:name rdf:label} !foaf:Person !wpdd:Author !wpdd:Assistent}{Лебедев С.В.} (ЛЭТИ)\\[1em]
% (ЛЭТИ)\\[1em]

%\paragraph{\normalfont Адаптация к учебному плану: }%
%\rdf{syll wpdd:courseDC schema:author {foaf:name rdf:label} !foaf:Person !wpdd:Adapter}{Черкашин~Е.А., к.т.н., доцент}
